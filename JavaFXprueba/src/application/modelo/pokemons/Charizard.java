...
import application.interfaces.Fuego;
...
public class Charizard extends Pokemon implements Fuego, Volador {
	...
	public Charizard(String alias, int vida, int defensa, int ataque, int experiencia, int nivel, int velocidad,
