...
import application.interfaces.Lucha;
 ...
 *
 */
public class Machamp extends Pokemon implements Lucha {


	public Machamp(String alias, int vida, int defensa, int ataque, int experiencia, int nivel, int velocidad,
	...
	@Override
	public int aBocajarro() {
		// TODO Auto-generated method stub
		return this.getAtaque()*3;
	}

	@Override
	public int doblePatada() {
		// TODO Auto-generated method stub
		return (int) ((this.getAtaque()*0.25)*1.5);
	}

	@Override
	public int ganchoAlto() {
		// TODO Auto-generated method stub
