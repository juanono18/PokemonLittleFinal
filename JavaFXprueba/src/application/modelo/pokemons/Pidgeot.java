 ...
 *
 */
public class Pidgeot extends Pokemon implements Volador {


	public Pidgeot(String alias, int vida, int defensa, int ataque, int experiencia, int nivel, int velocidad,
